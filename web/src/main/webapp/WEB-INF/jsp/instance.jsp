			...
			<div id="controller">
				...
				<div id="controlCenter">
					<div id="instControlBox">
						<table>
							<tr>
								<td><b>Select a map</b></td>
								<td><b>Invite list:</b></td>
							</tr>
							<tr>
								<td><div id="map-container">
										<div id="map-list"></div>
									</div></td>
								<td><div id="section-invite">
							...
							<tr>
								<td><div class="messageConstraint">
				...
				<div id="infoCenter">
					<div id="instInfoBox">
						<table id="instanceInfo">
							<tr>
								<td><b>Map:</b></td>
								<td><span id="inst-map-name"></span></td>
							</tr>
							<tr>
								<td><b>Start Time:</b></td>
								<td><span id="inst-start-time"></span></td>
							</tr>
							<tr>
								<td><b>In the instance:</b></td>
							</tr>
						</table>
						<div id="selected-list">
