<t:page title="Download Page" css="downloadPage.css">
	<div id="downloadPage">
		<div id="text">
			...
			<p>On your Android phone, go to the settings and</p>

			<p>By downloading and installing the application you agree to use</p>
			<p>the application to its purposes only.</p>
