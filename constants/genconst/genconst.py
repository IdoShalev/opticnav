...
languages, including Java, JavaScript and m4.
"""
...
def m4_generator(table, name, output):
    def write_value(name, value):
        if isinstance(value, int):
            print("define({0},{1})dnl".format(name, value), file=output);
        elif isinstance(value, dict):
    ...
    def write_values(name, values):
        for k in values:
            v = values[k];
            write_value(name+"__"+k, v);

    print("""divert(-1)
This file was generated by genconst.py. DO NOT MODIFY!
divert(0)dnl""", file=output);
