 ...
 * When a connection is accepted, the socket's {@link opticnav.daemon.protocol.chan.Channel Channel} is delegated to a
 * spawner, whose implementation initializes a service using the {@link opticnav.daemon.protocol.chan.Channel Channel}.
 * 
