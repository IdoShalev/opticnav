 ...
 * In cases where multiple lists need to cooperate (such as registering a device, which uses {@link ARDPendingList} and
 * {@link ARDPersistedList}), methods are placed in this class.
 * 
...
public final class ARDListsManager {
     ...
     * 
     * @return A PassCode/ConfCode pair, and a {@link BlockingValue} that unblocks when the device is registered.
     */
    ...
    /**
     * Find the device with the matching confirmation code and move it from {@link ARDPendingList}
     * to {@link ARDPersistedList}.
     * 
     * @param confCode The confirmation code provided
     * @return A new ARD ID generated by opticnav.persistence, or {@link opticnav.daemon.protocol.consts.ARDdARDProtocol#NO_ARD}
     *         if the confCode couldn't be found.
     * @throws IOException
     */
